...
int ht_setup(HashTable* table,
	...
	// Make sure that the capacity is atleast HT_MINIMUM_CAPACITY (8)
	if (capacity < HT_MINIMUM_CAPACITY) {
		capacity = HT_MINIMUM_CAPACITY;
	}

	// Allocate space for the nodes, and set the capacity and threshold
...
/* Allocates the array of nodes, capacity and threshold */
