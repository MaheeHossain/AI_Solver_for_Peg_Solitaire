...
} HTNode; // Basically a linked list with a key and value

typedef struct HashTable {
	size_t size;
	size_t threshold;
	size_t capacity; // Amount of nodes it can carry?

	size_t key_size;
	size_t value_size;

	comparison_t compare;
	hash_t hash; // Something to do with the hash function

	HTNode** nodes; // An array of nodes
