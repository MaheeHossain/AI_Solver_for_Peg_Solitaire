...
void find_solution( state_t* init_state  ) {
	// The board has been initialised to a layout, cursor is (4, 4), selected is false
	...
	node_t* n = create_init_node( init_state ); // Depth, move, state, parent
	list_t node_list = createList();
	node_list = insert(n, node_list);

	// create linked list, put n inside
